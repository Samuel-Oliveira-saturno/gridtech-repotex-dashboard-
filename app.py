...
# Caminho para as linhas de transmissão
# Assumimos que está na mesma pasta que o app.py
LINHAS_TRANSMISSAO_PATH = BASE / "linhas_transmissao.parquet"

# Diretório para as saídas GeoJSON
# Será criado um subdiretório 'geojson_outputs' dentro do BASE
GEOJSON_DIR = BASE / "geojson_outputs"

# Caminho para o logo
# Assumimos que o logo está na mesma pasta que o app.py
